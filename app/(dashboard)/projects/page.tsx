    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[var(--neutral-600)] mt-1">Tüm projeleri görüntüleyin ve yönetin</p>
        </div>
        <Button size="lg">
      ...
      {error ? (
          ...
          {projects.map((project: any) => (
            ...
            >
              ...
              <p className="text-sm text-[var(--neutral-600)] mb-4">
                {project.companies?.name || 'Firma bilgisi yok'}
              </p>
              <div className="flex items-center justify-between">
                <div>
        ...
        <div className="bg-white rounded-xl p-12 border border-[var(--neutral-200)] text-center">
          ...
          <p className="text-[var(--neutral-600)] mb-6">İlk projenizi ekleyerek başlayın</p>
          <Button>
            <Plus className="w-4 h-4 mr-2" />
            Yeni Proje Ekle
          </Button>
