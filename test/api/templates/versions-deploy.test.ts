...
import { POST } from '@/app/api/templates/versions/[id]/deploy/route'

vi.mock('@/lib/supabase/server', () => ({
  createClient: vi.fn(),
}))

describe('Template Version Deploy API', () => {
  ...
  it('should deploy version successfully', async () => {
    ...
    const request = new Request('http://localhost/api/templates/versions/version-1/deploy', {
      method: 'POST',
    })
